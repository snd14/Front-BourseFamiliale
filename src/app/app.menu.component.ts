    ...
    ngOnInit() {
        this.model = [
            ...
            },
            {
                label: 'Paiements',
                items: [
                    {label: 'Payer', icon: 'pi pi-fw pi-id-card', routerLink: ['/payer']},
                    {label: 'Historique', icon: 'pi pi-fw pi-id-card', routerLink: ['/historique']},
                    // {label: 'details-paiement', icon: 'pi pi-fw pi-id-card', routerLink: ['/details-paiement']},
                ]
            },

            {
                label: 'BENEFICIAIRES',
                items: [
                    {label: 'Liste bénéficiaires', icon: 'pi pi-fw pi-id-card', routerLink: ['/beneficiaires']},
                    //{label: 'Historique', icon: 'pi pi-fw pi-id-card', routerLink: ['/historique']}
                ]
            },
            {
                label: 'RAPPORTS',
                items: [
                    {label: 'Rapport par Bureau', icon: 'pi pi-fw pi-id-card', routerLink: ['/rapportBureau']},
                    {label: 'Rapport par Drp', icon: 'pi pi-fw pi-id-card', routerLink: ['/rapportDrp']},
                    {label: 'Rapport du Bureau', icon: 'pi pi-fw pi-id-card', routerLink: ['/rapportParBureau']},
                    {label: 'Rapport par Agent', icon: 'pi pi-fw pi-id-card', routerLink: ['/rapportParAgent']}
